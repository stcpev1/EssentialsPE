...
class Sudo extends BaseCommand{
    ...
    public function execute(CommandSender $sender, $alias, array $args): bool{
        ...
        if(substr($cmd, 0, 2) === "c:"){
            ...
            if(!$ev->isCancelled()){
                $this->sendTranslation($sender, "commands.sudo.sending-message", $m, $player->getDisplayName());
            ...
            $this->sendTranslation($sender, "commands.sudo.sending-command", $cmd, $player->getDisplayName());
        }
        return true;
    }
} 
